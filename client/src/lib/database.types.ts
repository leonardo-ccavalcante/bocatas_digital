...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      // Manual augmentation — will be regenerated by `supabase gen types` post-deploy
      // Reason: migration 20260501000002 dropped roles_visibles and added es_urgente;
      // migration 20260501000003 added the es_urgente column. Local supabase not running.
      ...
      // Manual augmentation — will be regenerated by `supabase gen types` post-deploy
      // Reason: migration 20260501000004 created this table; local types not regenerated.
      ...
      // Manual augmentation — will be regenerated by `supabase gen types` post-deploy
      // Reason: migration 20260501000005 created announcement_dismissals and
      // announcement_webhook_log; local types not regenerated.
      ...
      // Manual augmentation — will be regenerated by `supabase gen types` post-deploy
      // Reason: migration 20260501000005 created this table; local types not regenerated.
      ...
      // Manual augmentation — will be regenerated by `supabase gen types` post-deploy
      // Reason: migration 20260501000007 created bulk_import_previews; local types not regenerated.
    ...
    Functions: {
      // Manual augmentation — will be regenerated by `supabase gen types` post-deploy
      // Reason: migration 20260501000008 adds this function; local types not regenerated.
      confirm_bulk_announcement_import: {
        Args: {
          p_token: string
          p_autor_id: string
          p_autor_nombre: string | null
        }
        Returns: {
