...
export default [
  ...
  // when the file is next touched.
  {
    files: [
      ...
      // Personas.tsx REMOVED from the allow-list (MYT-121 resolved): split into
      // Personas.lists.tsx (VirtualizedDesktopList/VirtualizedMobileList) and
      // Personas.hooks.ts (usePersonsData). The max-lines ERROR gate now
      // enforces it — it can't silently regrow.
