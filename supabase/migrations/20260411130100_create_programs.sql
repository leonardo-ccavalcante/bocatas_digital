-- Migration 20: programs catalog + ENUM bridge for program_enrollments
...
-- ENUM bridge: convert program_enrollments.programa → UUID FK
...
-- Allow voluntario to INSERT enrollments (registration flow)
